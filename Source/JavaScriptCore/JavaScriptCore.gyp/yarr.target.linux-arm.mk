...
LOCAL_MODULE := third_party_WebKit_Source_JavaScriptCore_JavaScriptCore_gyp_yarr_gyp
...
### Rules for action "retgen":
$(gyp_intermediate_dir)/RegExpJitTables.h: gyp_local_path := $(LOCAL_PATH)
$(gyp_intermediate_dir)/RegExpJitTables.h: gyp_intermediate_dir := $(GYP_ABS_ANDROID_TOP_DIR)/$(gyp_intermediate_dir)
$(gyp_intermediate_dir)/RegExpJitTables.h: gyp_shared_intermediate_dir := $(GYP_ABS_ANDROID_TOP_DIR)/$(gyp_shared_intermediate_dir)
$(gyp_intermediate_dir)/RegExpJitTables.h: export PATH := $(subst $(ANDROID_BUILD_PATHS),,$(PATH))
$(gyp_intermediate_dir)/RegExpJitTables.h: $(LOCAL_PATH)/third_party/WebKit/Source/JavaScriptCore/create_regex_tables $(GYP_TARGET_DEPENDENCIES)
	@echo "Gyp action: third_party_WebKit_Source_JavaScriptCore_JavaScriptCore_gyp_JavaScriptCore_gyp_yarr_target_retgen ($@)"
	$(hide)cd $(gyp_local_path)/third_party/WebKit/Source/JavaScriptCore/JavaScriptCore.gyp; mkdir -p $(gyp_intermediate_dir); python ../create_regex_tables --no-tables "$(gyp_intermediate_dir)/RegExpJitTables.h"



GYP_GENERATED_OUTPUTS := \
	$(gyp_intermediate_dir)/RegExpJitTables.h
...
LOCAL_SRC_FILES := \
	third_party/WebKit/Source/JavaScriptCore/yarr/YarrCanonicalizeUCS2.cpp \
	third_party/WebKit/Source/JavaScriptCore/yarr/YarrInterpreter.cpp \
	third_party/WebKit/Source/JavaScriptCore/yarr/YarrPattern.cpp \
	third_party/WebKit/Source/JavaScriptCore/yarr/YarrSyntaxChecker.cpp
...
LOCAL_C_INCLUDES := \
	...
	$(LOCAL_PATH)/third_party/WebKit/Source/JavaScriptCore/runtime \
...
gyp_all_modules: third_party_WebKit_Source_JavaScriptCore_JavaScriptCore_gyp_yarr_gyp

# Alias gyp target name.
.PHONY: yarr
yarr: third_party_WebKit_Source_JavaScriptCore_JavaScriptCore_gyp_yarr_gyp
