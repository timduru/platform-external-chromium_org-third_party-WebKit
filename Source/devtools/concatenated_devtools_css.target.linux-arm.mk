...
$(gyp_shared_intermediate_dir)/resources/inspector/showhint.css: $(LOCAL_PATH)/third_party/WebKit/Source/devtools/front_end/cm/showhint.css $(GYP_TARGET_DEPENDENCIES) | $(ACP)
	@echo Copying: $@
	$(hide) mkdir -p $(dir $@)
	$(hide) $(ACP) -r $< $@
